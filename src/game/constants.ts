...
export const HELICOPTER = {
  horizontalAcceleration: 340,
  horizontalCounterAcceleration: 680,
  climbAcceleration: 470,
  descentAcceleration: 310,
  passiveGravity: 110,
  horizontalDrag: 190,
  groundedHorizontalDrag: 520,
  verticalDrag: 100,
  maximumHorizontalSpeed: 260,
  maximumVerticalSpeed: 175,
  safeLandingHorizontalSpeed: 90,
  safeLandingVerticalSpeed: 125,
